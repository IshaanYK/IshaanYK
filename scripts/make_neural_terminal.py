...
svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="{W}" height="{H}" viewBox="0 0 {W} {H}">
  ...
  <g transform="translate(24, 58)">
    ...
    <g transform="translate(0, 80)">
      ...
      <text x="265" y="18" fill="#30d158" class="font-mono" font-size="10.5">1,190+ SYNCED</text>
    </g>
  ...
  <g transform="translate(450, 58)">
    ...
    <!-- Top Row -->
    <g transform="translate(0, 16)">
      <!-- Card 1: Token Throughput -->
      <g transform="translate(0, 0)">
        <rect width="186" height="58" rx="8" fill="#ffffff" fill-opacity="0.03" stroke="#ffffff" stroke-opacity="0.06" stroke-width="0.8"/>
        <text x="14" y="20" fill="#86868b" class="font-mono" font-size="9.5" font-weight="600" letter-spacing="0.5px">TOKEN THROUGHPUT</text>
        <text x="14" y="44" fill="#2997ff" class="font-mono" font-size="16.5" font-weight="700">42.8k <tspan font-size="10.5" fill="#86868b" font-weight="400">tok/sec</tspan></text>
      </g>

      <!-- Card 2: Context Compression -->
      <g transform="translate(196, 0)">
        <rect width="186" height="58" rx="8" fill="#ffffff" fill-opacity="0.03" stroke="#ffffff" stroke-opacity="0.06" stroke-width="0.8"/>
        <text x="14" y="20" fill="#86868b" class="font-mono" font-size="9.5" font-weight="600" letter-spacing="0.5px">CONTEXT EFFICIENCY</text>
        <text x="14" y="44" fill="#30d158" class="font-mono" font-size="16.5" font-weight="700">99.8% <tspan font-size="10.5" fill="#86868b" font-weight="400">compacted</tspan></text>
      </g>
    </g>

    <!-- Bottom Row -->
    <g transform="translate(0, 84)">
      <!-- Card 3: Embedding Latency -->
      <g transform="translate(0, 0)">
        <rect width="186" height="58" rx="8" fill="#ffffff" fill-opacity="0.03" stroke="#ffffff" stroke-opacity="0.06" stroke-width="0.8"/>
        <text x="14" y="20" fill="#86868b" class="font-mono" font-size="9.5" font-weight="600" letter-spacing="0.5px">EMBEDDING LATENCY</text>
        <text x="14" y="44" fill="#f5f5f7" class="font-mono" font-size="16.5" font-weight="700">12.4ms <tspan font-size="10.5" fill="#30d158" font-weight="600">OPTIMAL</tspan></text>
      </g>

      <!-- Card 4: Tool Consensus -->
      <g transform="translate(196, 0)">
        <rect width="186" height="58" rx="8" fill="#ffffff" fill-opacity="0.03" stroke="#ffffff" stroke-opacity="0.06" stroke-width="0.8"/>
        <text x="14" y="20" fill="#86868b" class="font-mono" font-size="9.5" font-weight="600" letter-spacing="0.5px">AGENT CONSENSUS</text>
        <text x="14" y="44" fill="#2997ff" class="font-mono" font-size="16.5" font-weight="700">100% <tspan font-size="10.5" fill="#86868b" font-weight="400">verified</tspan></text>
      </g>
    </g>
  </g>
</svg>
