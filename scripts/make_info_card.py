...
ROWS = [
    ("host",),
    ("kv", "Now", "AI Engineer & Developer"),
    ("kv", "Focus", "Agentic Systems & RAG Architectures"),
    ("kv", "Links", "ishaanyk.github.io/portfolio-me/"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI/ML", "Python, OpenAI API, LangChain, PyTorch"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Tailwind"),
    ("kv", "Backend", "Node.js, FastAPI, PostgreSQL, Docker"),
    ("kv", "Cloud", "AWS, Vercel, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building custom AI agents and workflow automations"),
    ("bul", "Designing high-performance full-stack web applications"),
]
