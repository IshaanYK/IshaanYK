...
svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="{W}" height="{H}" viewBox="0 0 {W} {H}">
  <defs>
    ...
    <style>
      ...
      .t4 {{ animation: loopTag4 16s infinite; }}
    </style>
  </defs>
  ...
  <g transform="translate(26, 150)" class="font-sans">
    <text x="0" y="0" fill="#86868b" font-size="11">
      📍 Location: <tspan fill="#f5f5f7">India</tspan> &nbsp;•&nbsp; 💼 Status: <tspan fill="#30d158">Available for Full-Time / Contract / Remote</tspan> &nbsp;•&nbsp; ✉️ <tspan fill="#2997ff">isen97509@gmail.com</tspan>
    </text>
  </g>
</svg>
"""
